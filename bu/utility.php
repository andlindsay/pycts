...
$sel_roster = $sel_admin = $sel_stats = $sel_studies  = $sel_backup_restore = $sel_sys_opts = "";
$sel = 'class="selected"';
if( isset($_GET['admin']) )
	$sel_admin = $sel;
...
if( $_SESSION['role'] == 0 || $_SESSION['role'] == 1 )
	echo '<li><a ' . $sel_stats . ' href="user.php?stats">Statistics</a></li>';
if( $_SESSION['role'] == 0 )
	echo '<li><a ' . $sel_studies . ' href="user.php?studies">Studies</a></li>';
if( $_SESSION['role'] == 0 )
        echo '<li><a ' . $sel_admin . ' href="user.php?admin">User Management</a></li>';
if( $_SESSION['role'] == 0 )
